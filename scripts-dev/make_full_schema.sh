...
usage() {
  ...
  echo "        Schema deltas past this version will still be applied; they should be"
  echo "        temporarily deleted first (as well as homeserver code temporarily tweaked"
