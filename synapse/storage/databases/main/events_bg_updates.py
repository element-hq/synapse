            ...
            for (
                ...
                if (
                    ...
                    assert (
                        ...
                        + f" but our last join membership was at {last_to_insert_join_membership_info.membership_event_stream_ordering}"
                        + f" and our current membership is at {membership_event_stream_ordering}"
                    )
