...
class ExperimentalConfig(Config):
    ...
    def read_config(
        ...
        # Previously by default since this option was added after adding the feature,
        # but the MSC is now closed and this feature is due to be ripped out.
        # It is not recommended that both MSC2697 and MSC3814 both be enabled at
        # once.
        self.msc2697_enabled: bool = experimental.get("msc2697_enabled", False)
