...
class RoomPermissionsTestCase(RoomBase):
    ...
    async def test_invited_permissions(self) -> None:
        ...
        await self.helper.change_membership(
            room=room,
            src=self.user_id,
...
class RoomStateTestCase(RoomBase):
    ...
    async def test_get_state_cancellation(self) -> None:
        ...
        channel = await make_request_with_cancellation_test(
...
class RoomsMemberListTestCase(RoomBase):
    ...
    async def test_get_member_list_no_permission_former_member(self) -> None:
        ...
        # ban the user
        await self.helper.change_membership(room_id, "@alice:red", self.user_id, "ban")
...
class MSC4293RedactOnBanKickTestCase(unittest.FederatingHomeserverTestCase):
    ...
    async def test_banning_remote_member_with_flag_redacts_their_events(self) -> None:
        ...
        res = await self.helper.change_membership(
