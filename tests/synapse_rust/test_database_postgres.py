...
class PostgresConnectionTestCase(unittest.TestCase):
    ...
    def test_executemany_rowcount_is_total_affected(self) -> None:
        ...
        self.assertEqual(self.conn.run_interaction(interaction), 3)
    ...
    def test_executemany_leaves_no_result_set(self) -> None:
        ...
        self.assertIsNone(self.conn.run_interaction(describe))
    ...
    def test_executemany_empty_is_noop(self) -> None:
        ...
        self.assertEqual(self.conn.run_interaction(interaction), 0)
    ...
    def test_executemany_rolls_back_on_error(self) -> None:
        ...
        try:
            ...
            self.assertIsNone(self.conn.run_interaction(table_exists))
        finally:
...
class PostgresConnectionDrivenTestCase(unittest.TestCase):
    ...
    Where ``PostgresConnectionTestCase`` exercises the ``run_interaction``
    convenience wrapper, these drive the connection the way Synapse's own
